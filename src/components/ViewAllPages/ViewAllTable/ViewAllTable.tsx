...
import { useTable, HeaderGroup, Column, Row, Cell, usePagination } from 'react-table'

import { DsBlockObj, TxBlockObj, TransactionObj, PendingTxnResult } from '@zilliqa-js/core/src/types'

import './ViewAllTable.css'

interface IViewAllTable<T extends object> {
...
const ViewAllTable = ({ columns, data, isLoading, fetchData, pageCount: controlledPageCount, processMap }
  : IViewAllTable<DsBlockObj | TxBlockObj | TransactionObj | PendingTxnResult>) => {
